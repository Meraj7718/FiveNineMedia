...
//                             <p className="text-sm text-gray-600">{quote.mobile_no}</p>
...
//                           <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{quote.mobile_no}</td>
...
export default function AdminPage() {
    ...
    return _jsx(AdminDashboard, { user: user, onLogout: handleLogout });
}
